...
def main():
    ...
    try:
        # Load game links
        with open('Scraping_data/game_links.json', 'r') as f:
        ...
        with open('Scraping_data/shot_chart.json', 'w') as f:
        ...
        print(f"Scraping completed. Saved {len(shots_data)} shots to Scraping_data/shot_chart/shot_chart.json")
