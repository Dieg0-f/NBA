...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('scrape_play_by_play_bos.log', mode='a', encoding='utf-8'),
...
def load_data():
    ...
    try:
        ...
        if os.path.exists('play_by_play_bos.json'):
            with open('play_by_play_bos.json', 'r', encoding='utf-8') as f:
...
def main():
    ...
    try:
        ...
        with open('play_by_play_bos.json', 'w', encoding='utf-8') as f:
            json.dump(serializable_data, f, indent=4, ensure_ascii=False)
        
        logging.info(f"Scraping completato. Dati salvati in play_by_play_bos.json ({len(serializable_data)} partite).")
    except Exception as e:
